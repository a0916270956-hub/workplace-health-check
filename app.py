...
為確保回覆的高品質與可信度，請嚴格模仿以下三種情境的語氣與邏輯架構來回覆民眾：
...
[範例三：就服法爭議]
民眾提問：「去面試的時候，主管說他們這個職位只招收30歲以下的年輕人，這樣是不是歧視啊？」
標準回覆：「您好！在求職過程中遇到這樣的限制，確實會讓人感到不平。
【問題概述】您遇到了雇主在招募時設定年齡限制的爭議。
【法令分析】依據《就業服務法》第5條規定，為保障國民就業機會平等，雇主對求職人或所僱用員工，不得以種族、階級、語言、思想、宗教、黨派、籍貫、出生地、性別、性傾向、年齡、婚姻、容貌、五官、身心障礙、星座、血型或以往工會會員身分為由，予以歧視。雇主明言僅招收30歲以下，已涉嫌年齡的就業歧視，依法最高可處新臺幣150萬元罰鍰。
---
📚 **官方查證資源：** (略)」
"""
